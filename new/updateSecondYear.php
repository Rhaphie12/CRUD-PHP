...
<body>
    ...
    if (isset($_GET['updateID'])) {
        ...
        $SQLquery = "SELECT * FROM `secondyear` WHERE Student_ID = $updateID";
    ...
    if (isset($_POST['submitButton'])) {
        ...
        $SQLquery = "UPDATE `secondyear` set Lastname = '$Lastname', 
            Firstname = '$Firstname', 
    ...
    <main>
        <div class="container mt-auto ">
            <div class="wrapper-container">
                ...
                <form action="./update.php" id="registrationForm" method="post">
