...
<body>
    ...
    if (isset($_GET['updateID'])) {
        ...
        $SQLquery = "SELECT * FROM `thirdyear` WHERE Student_ID = $updateID";
    ...
    if (isset($_POST['submitButton'])) {
        ...
        $SQLquery = "UPDATE `thirdyear` set Lastname = '$Lastname', 
            Firstname = '$Firstname', 
    ...
    <main>
        <div class="container mt-auto ">
            <div class="wrapper-container">
                ...
                <form action="./updateThirdYear.php" id="registrationForm" method="post">
                    ...
                    <div class="information-section">
                        ...
                        echo "<option value='First year'" . ($Yearlevel == 'First year' ? 'selected' : '') . ">First year</option>";
                        echo "<option value='Second year'" . ($Yearlevel == 'Second year' ? 'selected' : '') . ">Second year</option>";
                        echo "<option value='Third year'" . ($Yearlevel == 'Third year' ? 'selected' : '') . ">Third year</option>";
                        echo "<option value='Fourth year'" . ($Yearlevel == 'Fourth year' ? 'selected' : '') . ">Fourth year</option>";
                        echo "</select>";
                        ?>
                        <?php
                        ...
                        echo "<option value='BSOA'" . ($Course == 'BSOA' ? 'selected' : '') . ">BSOA</option>";
                        echo "<option value='BSTM'" . ($Course == 'BSTM' ? 'selected' : '') . ">BSTM</option>";
                        echo "<option value='BSHM'" . ($Course == 'BSHM' ? 'selected' : '') . ">BSHM</option>";
                        echo "</select>";
                        ?>
                    </div>
