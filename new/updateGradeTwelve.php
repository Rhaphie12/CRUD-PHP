...
<body>
    ...
    if (isset($_GET['updateID'])) {
        ...
        $SQLquery = "SELECT * FROM `gradetwelve` WHERE Student_ID = $updateID";
    ...
    if (isset($_POST['submitButton'])) {
        ...
        $SQLquery = "UPDATE `gradetwelve` set Lastname = '$Lastname', 
            Firstname = '$Firstname', 
        ...
        if ($result) {
            echo '
                <script>
                    ...
                    window.location.href="gradetwelve.php";
                </script>
            ';
        } else {
            ...
            <div class="wrapper-container">
                ...
                <form action="./update.php" id="registrationForm" method="post">
                    ...
                    <div class="information-section">
                        ...
                        ?>
                        <?php
                        echo "<select id'Track' name='Track'>";
                        ...
                        echo "<option value='GAS'" . ($Track == 'GAS' ? 'selected' : '') . ">GAS</option>";
