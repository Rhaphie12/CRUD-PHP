...
<body>
    ...
    if (isset($_POST['submitButton'])) {
        ...
        // $Address = $HouseNumber . " " . $Street . " " . $Barangay . " " . $City;

        // Check if the selected year level is "First year"
        if ($Yearlevel === "First year") {
            $SQLquery = "INSERT INTO firstyear (Student_ID, Firstname, Lastname, Middlename, Birthday, Citizenship, Year_Level, Course, House_number, Street, Barangay, City) 
            ...
            $SQLquery = "INSERT INTO secondyear (Student_ID, Firstname, Lastname, Middlename, Birthday, Citizenship, Year_Level, Course, House_number, Street, Barangay, City) 
            VALUES('$Student_ID', '$Firstname', '$Lastname', '$Middlename', '$Birthday', '$Citizenship', '$Yearlevel', '$Course', '$House_number', '$Street', '$Barangay', '$City')";
        } else if ($Yearlevel === "Third year") {
            $SQLquery = "INSERT INTO thirdyear (Student_ID, Firstname, Lastname, Middlename, Birthday, Citizenship, Year_Level, Course, House_number, Street, Barangay, City) 
            VALUES('$Student_ID', '$Firstname', '$Lastname', '$Middlename', '$Birthday', '$Citizenship', '$Yearlevel', '$Course', '$House_number', '$Street', '$Barangay', '$City')";
        } else if ($Yearlevel === "Fourth year") {
            $SQLquery = "INSERT INTO fourthyear (Student_ID, Firstname, Lastname, Middlename, Birthday, Citizenship, Year_Level, Course, House_number, Street, Barangay, City) 
            VALUES('$Student_ID', '$Firstname', '$Lastname', '$Middlename', '$Birthday', '$Citizenship', '$Yearlevel', '$Course', '$House_number', '$Street', '$Barangay', '$City')";
        } else {
            echo "Invalid Table";
        }
    ...
    <main>
        <div class="container mt-auto ">
            <div class="wrapper-container">
                ...
                <form action="./registerStudent.php" id="registrationForm" method="post">
                    <div class="name-section">
                        <label>Name</label>
                        <input type="text" required placeholder="Enter your Student ID" name="student_ID" id="student_ID" />
                        <input type="text" required placeholder="Enter your Last Name" name="Lastname" id="Lastname" />
