                ...
                <div class="col">
                    <div class="card mt-1">
                        <div class="card-header">
                            <h2 class="display-6 text-center">College Data (Fourth Year)</h2>
                        </div>
                        <div class="card-body">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "
                                            <tr>
                                                ...
                                                <td>" . $row["Barangay"] . "</td>
                                                <td>" . $row["City"] . "</td>
                                                <td><a href='./updateFourthYear.php?updateID=" . $row["Student_ID"] . "'class='btn btn-success'>Update</a></td>
                                                <td><a href='./deleteFourthYear.php?deleteID=" . $row["Student_ID"] . "'class='btn btn-danger'>Delete</a></td>
                                            </tr>
                                            ";
                                    }
                                } else {
